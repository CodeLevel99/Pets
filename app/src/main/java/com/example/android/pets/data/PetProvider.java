...
public class PetProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if (weight < 1) {
            throw new IllegalArgumentException("Pet needs to weigh something man.");
        }
        ...
        //notify all listeners that data changed for pet content uri
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(PetEntry.COLUMN_PET_WEIGHT)) {
            ...
            if (weight != null && weight < 0) {
                throw new IllegalArgumentException("Pet needs to weight something man.");
            }
        }
        ...
        //returns number of database rows affected by update statement
        return rowsUpdated;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                petsDeleted = database.delete(PetEntry.TABLE_NAME, selection, selectionArgs);
